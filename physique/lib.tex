...
\newenvironment{calcul}{\begin{align}\begin{split}}{\end{split}\end{align}}
\newenvironment{parties}{\begin{tabular}{M{5cm} M{5cm}}}{\end{tabular}}

\usepackage[explicit]{titlesec}
\titleformat{\section}{\bigskip\bigskip\bigskip\fontsize{15}{20}\sffamily\bfseries}{\thesection.}{16pt}{#1}
\titleformat{\subsection}{\fontsize{12}{18}\sffamily\bfseries}{\thesubsection.}{12pt}{#1}
\titleformat{\subsubsection}{\fontsize{5}{8}\sffamily\large\bfseries}{\thesubsubsection.}{8pt}{#1}
